    ...
    <div class="container my-auto text-center">
        ...
        <div>
            <form action="index.php#viewResults" method="get">
                ...
                <div>
                    <div class="form-check d-inline" style="padding: 0px;margin: 15px;"><input class="form-check-input" type="radio" name="type" value="images" checked="" id="checkImages"><label class="form-check-label" for="checkImages">Uploaded Images</label></div>
                    <div class="form-check d-inline" style="padding: 0px;margin: 15px;"><input class="form-check-input" type="radio" name="type" value="audios" id="checkAudio"><label class="form-check-label" for="checkAudio">Uploaded Audio</label></div>
                    <div class="form-check d-inline" style="padding: 0px;margin: 15px;"><input class="form-check-input" type="radio" name="type" value="videos" id="checkVideo"><label class="form-check-label" for="checkVideo">Uploaded Videos</label></div>
                    <div class="form-check d-inline" style="padding: 0px;margin: 15px;"><input class="form-check-input" type="radio" name="type" value="files" id="checkFiles"><label class="form-check-label" for="checkFiles">Other Files (pdf, xls, doc, ...)</label></div>
                    <div class="form-check d-inline" style="padding: 0px;margin: 15px;"><input class="form-check-input" type="radio" name="type" value="users" id="checkUsers"><label class="form-check-label" for="Users">Registrated Users</label></div>
